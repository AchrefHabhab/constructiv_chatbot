    ...
    $(function () {
        var getMessageText, message_side, sendMessage, deleteMessages;
        message_side = 'right';
...
return $messages.animate({ scrollTop: $messages.prop('scrollHeight') }, 300);
        ...
        deleteMessages = function () {
            ...
            $.get("/deletes").done(function(data) {
                writingMessage.draw();
            });
        }
        ...
        $('.clear_message').click(function (e) {
            $('.message_input').val('');
        });
    ...
    writingMessage = new Message({
        text: 'construktiv\'s bot here, how can I help you today?',
        message_side: 'left'
    });
    writingMessage.draw();
